...
quota_wind_R0 = 0
quota_wind_R1 = 0
quota_wind_R2 = 6500 * 1  #6084.7
quota_wind_R3 =  500 * 1 #260.1
quota_wind_R4 =  0
quota_wind_total = quota_wind_R0 +  quota_wind_R1 + quota_wind_R2 + quota_wind_R3 + quota_wind_R4 #6344.8

quota_solar_R0 =  100  #23.34
quota_solar_R1 =  3500 * 1 #3255.36
quota_solar_R2 =  6500 * 1 #6072.28
quota_solar_R3 = 6000 * 1 #5602.08
quota_solar_R4 =  3500 * 1 #3175.94
...
# quota_biomass_total = quota_biomass_R0 + quota_biomass_R1 + quota_biomass_R2 + quota_biomass_R3 + quota_biomass_R4
...
# quota_bgec_R3 =   0
# quota_bgec_R4 =  0
# quota_bgec_total = quota_bgec_R0 + quota_bgec_R1 + quota_bgec_R2 + quota_bgec_R3 + quota_bgec_R4
...
# quota_msw_R3 =   104.33
# quota_msw_R4 =  91
# quota_msw_total = quota_msw_R0 + quota_msw_R1 + quota_msw_R2 + quota_msw_R3 + quota_msw_R4

print("quota_solar_total = ", quota_solar_total)
print("quota_wind_total = ", quota_wind_total)
# print("quota_biomass_total = ", quota_biomass_total)
# print("quota_bgec_total = ", quota_bgec_total)
# print("quota_msw_total = ", quota_msw_total)
...
xr_ref['cap_wind'] = np.round(solution['cap_wind'] * solution['built_wind'],4)
xr_ref['cap_solar'] = np.round(solution['cap_solar'] * solution['built_solar'],4)
# xr_ref['cap_biomass'] = np.round(solution['cap_biomass'] * solution['built_biomass'],4)
# xr_ref['cap_bgec'] = np.round(solution['cap_bgec'] * solution['built_bgec'],4)
# xr_ref['cap_msw'] = np.round(solution['cap_msw'] * solution['built_msw'],4)
